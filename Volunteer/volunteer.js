...
// Volunteer Btn //
var volunteerApplicationBtn = document.getElementById('volunteer-application');
volunteerApplicationBtn.addEventListener('click', function(){
    window.location.href = "/AVERS/Volunteer/VolunteerApplication/volunteerapplication.php";
})
