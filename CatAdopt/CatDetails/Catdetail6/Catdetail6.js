...
document.getElementById("adopt-btn").addEventListener("click", () => {
  ...
  if (currentURL.includes("catdetail")) {
    window.location.href = "/AVERS/DogAdopt/dog-adopt.php";
  }else {
...
// Adopt Apply Btn //
  ...
  [btn1, btn2].forEach(button => {
    button.addEventListener("click", () => {
      window.location.href = "/AVERS/CatAdopt/cat-adoption-form/cat-adoption-form.php";
    });
  });
...
images.forEach((img, index) => {
  img.addEventListener("click", () => {
    if (index === 0) {
      window.location.href = "../Catdetail0/catdetail0.php";
    } else if (index === 1) {
      window.location.href = "../Catdetail4/catdetail4.php";
    } else if (index === 2) {
      window.location.href = "../Catdetail3/catdetail3.php";
    }else if (index === 3) {
      window.location.href = "../Catdetail7/catdetail7.php";
    }else {
