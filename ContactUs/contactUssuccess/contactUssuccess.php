...
<head>
    ...
    <link rel="stylesheet" href="contactUssuccess.css">
...
<body>
    ...
    <header>
        <div class="logo">
            <img src="./contactUssuccess-img/logo.jpg" alt="the logo of avers">
            <span>
                <div class="logo-name">
                    <h3>Avers</h3>
        ...
        <div class="contacts">
            ...
            <div class="adopt-btn">
                <button id="adopt-btn"><img src="./contactUssuccess-img/Btn-paw.png" alt="" height = 28px width = 28px>Adopt Here</button>
            </div>
        </div>
    </header>
...
<script src="./contactUssuccess.js"></script>
</html>